  ...
  return <div className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 gradient-hero overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-secondary/30 rounded-full blur-3xl animate-float" style={{
          animationDelay: "1s"
        }} />
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="flex flex-wrap gap-4">
                <Button variant="hero" size="xl" onClick={() => navigate("/editor")} className="text-orange-600 bg-teal-900 hover:bg-teal-800 text-base">
                  Start Visualizing
                </Button>
            ...
            animationDelay: "0.2s"
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl animate-glow-pulse">
                <img src={heroHouse} alt="Beautiful modern house exterior ready for paint visualization" className="w-full h-auto" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            delay: "0.3s"
          }].map((feature, index) => <div key={index} className="bg-card rounded-2xl p-6 shadow-lg hover:shadow-xl transition-smooth hover:-translate-y-2 animate-fade-in" style={{
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              ...
              description: "See exactly how colors will look on your walls"
            }, {
              title: "Save Time & Money",
              description: "Avoid costly painting mistakes and repaints"
            }, {
              title: "Brand Colors",
              description: "Access real paint shades from Asian Paints, Dulux & more"
            }].map((benefit, index) => <div key={index} className="bg-card/50 backdrop-blur-sm rounded-xl p-6 border border-white/10">
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[{
            name: "Sarah Johnson",
            text: "This tool saved me from making a huge mistake! I could visualize different colors before committing.",
            rating: 5
          }, {
            name: "Michael Chen",
            text: "The polygon selection is incredibly precise. Perfect for complex walls and trim work.",
            rating: 5
          }, {
            name: "Emma Davis",
            text: "Love the real brand colors! I found my perfect shade and ordered the exact paint.",
            rating: 5
          }].map((testimonial, index) => <div key={index} className="bg-card rounded-xl p-6 shadow-lg">
                <div className="flex mb-3">
                  {[...Array(testimonial.rating)].map((_, i) => <span key={i} className="text-primary text-xl">★</span>)}
                </div>
      ...
      <section className="py-20 gradient-primary relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <Button variant="hero" size="xl" onClick={() => navigate("/editor")} className="bg-stone-800 hover:bg-stone-700 text-neutral-800">
            Get Started Now
          </Button>
        </div>
      </section>
